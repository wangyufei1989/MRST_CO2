 function [n,h]=kinetic_reaction_sub(Pl,Pg,nu,G,G_t,n,H,Tk,Sr,dt)
...
nkk=nkk+1;
[L,R]=LRH(dtt,n,n0,G_et,G_kt,nu_e,nu_k,r_k,dr_k,A,MM,h,loga,Tk,Pl);
...
function [L,R]= LRH(dt,n,n0,G_et,G_kt,nu_e,nu_k,r_k,dr_k,A,MM,h,loga,Tk,Pl)


R_g=83.144598; %universal gas constant []
k1=10^(10.329-8.48);%from data base of phreeqc
k2=10^(1.623)*exp((Pl-1)*32.6/R_g/Tk);%for Tc =40
k3=10^(16.681-10.329);
k4=10^(-10.329);
k5=10^(-14);
k=[k2;
