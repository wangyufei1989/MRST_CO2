...
W = addWell(W, G, rock, wc(i), 'Type', opt.Type, 'Val', opt.Val,   ...
           ...
           'Sign', opt.Sign, 'RefDepth', opt.RefDepth, 'lims', opt.lims,'pressure',opt.pressure,'rho',opt.rho,'pressure0',opt.pressure0,'rho0',opt.rho0, 'dp',opt.dp, 'mu0',opt.mu0,'frac',opt.frac,'mu',opt.mu);
